<template>
  <section class="detail-content">
    <div class="detail-materials">
      ...
      <h2>用料</h2>
      <div class="detail-materials-box clearfix" v-if="info.raw_material.main_material">
        <h3>主料</h3>
        <ul>
          <li class="" v-for="item in info.raw_material.main_material">
            {{item.name}}
      ...
      <div class="detail-materials-box clearfix" v-if="info.raw_material.accessories_material.length">
        <h3>辅料</h3>
        <ul>
          <li class="" v-for="item in info.raw_material.accessories_material">
            {{item.name}}
            <span>{{item.specs}}</span>
          </li>
        </ul>
