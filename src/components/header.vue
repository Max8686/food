    ...
    <div class="header">
      <div class="header_c">
        <el-row type="flex" justify="start" align="middle">
          ...
          <el-col :span="6" :offset="3" class="avatar-box" v-show="!isLogin">
            <router-link :to="{name:'login',query:'userInfo'}" class="user-name">登录</router-link>
            <router-link :to="{name:'login',query:'userInfo'}" class="collection">注册</router-link>
            <router-link :to="{name:'car'}" class="collection">购物车</router-link>
          </el-col>
        </el-row>
      </div>
    </div>
